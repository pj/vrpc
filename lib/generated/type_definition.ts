...
//
//   const typeDefinition = Convert.toTypeDefinition(json);
//
...
export class Convert {
    public static toTypeDefinition(json: string): TypeDefinition[] {
        return cast(JSON.parse(json), a(r("TypeDefinition")));
    }

    public static typeDefinitionToJson(value: TypeDefinition[]): string {
        return JSON.stringify(uncast(value, a(r("TypeDefinition"))), null, 2);
    }
}
